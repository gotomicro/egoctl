...
// It looks for egoctl.yaml or egoctl.json in the current path,
...
func LoadConfig() {
	...
	if Conf.Version != confVer {
		logger.Log.Warn("Your configuration file is outdated. Please do consider updating it.")
		logger.Log.Hint("Check the latest version of egoctl's configuration file.")
	}
